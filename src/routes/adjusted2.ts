...
const david = plot.addRoute(buddha, eastLine, 70, 'David Point', {labelDot: false, makeDot: false, label: routeLabeler});
const soldier = plot.addRoute(david, eastLine, 58, 'Soldier Point', {labelDot: false, makeDot: false, label: routeLabeler});
...
plot.addRoute(lady, 24, 45, 'Mirror from Lady', {makeDot: false, type: LineType.DASHED, label: routeLabeler});
...
const hoop3 = plot.addRoute(westPlatform, westLine, 67, 'Hoop D Line', {makeDot: false, label: routeLabeler});
plot.addRoute(hoop3, westLine, 139, 'Buddah (return)', {makeDot: false, label: routeLabeler});
